...
const config: Config = {
    ...
    redirect_uri: "http://快乐星球.site/qq/callback", // 请修改成你的信息
...
if (import.meta.env.MODE === "development") {
    ...
    config.redirect_uri = "http://快乐星球.site/qq/callback";
    ...
    config.baseURL="/test";
    config.baseFileURL= "/fileSever-dev";
    config.fileServerHost = "http://快乐星球.site:8211";
    config.serverHost = "http://localhost:3000";
    config.host = "http://localhost:3000";
    config.redirect_uri = "http://快乐星球.site/qq/callback";
    config.client_id = "40cca80d10082a99e683";
    ...
    config.fileServerHost = "http://快乐星球.site:8211";
    config.serverHost = "http://快乐星球.site:9090";
    config.host = "http://快乐星球.site";
    config.redirect_uri = "http://快乐星球.site/qq/callback";
    config.client_id = "40cca80d10082a99e683";
    config.client_secret = "1bcc096ef149e5c0ff7649da0cde69fa8df01638";
}
