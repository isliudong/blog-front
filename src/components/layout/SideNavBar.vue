  ...
  >
    ...
    <div class="blogger-info">
      <v-avatar size="110" style="margin-bottom:0.5rem">
        <img :src="this.$store.state.webConfig.websiteConfig?.websiteAvatar"/>
      </v-avatar>
    </div>
    <!-- 博客信息 -->
      ...
      <div class="blog-info-data">
        <router-link to="/archives">
          ...
          <div style="font-size: 1.125rem;">
            {{ this.$store.state.webConfig.articleCount }}
          </div>
        </router-link>
      </div>
      <div class="blog-info-data">
        <router-link to="/categories">
          ...
          <div style="font-size: 1.125rem">
            {{ this.$store.state.webConfig.categoryCount }}
          </div>
        </router-link>
      </div>
      <div class="blog-info-data">
        <router-link to="/tags">
          ...
          <div style="font-size: 1.125rem">
            {{ this.$store.state.webConfig.tagCount }}
          </div>
        </router-link>
      </div>
    </div>
