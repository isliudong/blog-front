<template>
  <div class="" style="width: 100%">
    <el-dialog v-model="state.newArticleForm" title="新文章">
      <el-form :model="state.formLabelAlign">
        <el-form-item label="标题" :label-width="state.formLabelWidth">
          <el-input v-model="state.formLabelAlign.title" autocomplete="off" placeholder="请输入标题..."></el-input>
        </el-form-item>
        <el-form-item label="封面">
          <div style="display: flex;overflow: hidden; height: 200px">
            ...
            <img-upload style="width: 400px" @file-key="getFileKey"></img-upload>
          </div>
        </el-form-item>
      ...
      <span class="dialog-footer">
        ...
        <el-button :disabled="state.formLabelAlign.title===''" type="primary" @click="save">确定</el-button>
      </span>
      </template>
    </el-dialog>
    <el-form
    ...
    <md-editor :text="state.formLabelAlign.content" @editor-save="saveArticle"></md-editor>
  </div>
</template>
