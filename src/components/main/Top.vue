      ...
      <transition-group name="el-fade-in">
        ...
        >
          <div style="padding-left: 20px">
            ...
            <div class="meta">
              <div style="flex: 1 ;min-width: 180px;">
                <el-button style="border: 0; background-color: transparent" @click.prevent="likeOrCancelLike(article)">
                  <vue-star :is-click="article.userLiked" animate="yourAnimateCssClass"
            ...
            <div v-if="state.comments.get(article.id)" class="comments">
...
import {fetchHotList} from "../../api/article";
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const handleSearch = async (): Promise<void> => {
      ...
      const data: Page<Article> = await fetchHotList(state.params);
